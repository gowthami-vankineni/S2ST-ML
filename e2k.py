...
# Function to translate English text to Kannada and synthesize as audio file
def translate_and_synthesize_audio(english_text):
    try:
        ...
        # Synthesize Kannada text as audio
...
# Translate English text to Kannada and synthesize as audio file
if english_text:
